"""Merge the v15 LoRA adapter into Qwen2.5-7B base -> full model ollama can import.
...
ADAPTER = r"D:\Wren-Companion\state\little_brain\adapter"   # holds v15 after the 08-01 bake
OUT = r"D:\Wren-Companion\state\little_brain\merged_v15"
