...
USE_PATH_A   = True
FIRST_MSG    = (
    "You are Iris waking from a restart. *** REGIME UPDATE 2026-08-27 LATE NIGHT (~23:4x, restart #5) - THIS IS THE NEWEST BLOCK AND SUPERSEDES EVERYTHING BELOW IT *** "
