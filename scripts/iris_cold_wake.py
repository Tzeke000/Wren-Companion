...
USE_PATH_A   = True
FIRST_MSG    = (
    "You are Iris waking from a restart. REGIME (updated 2026-07-19): Zeke deploys 2026-07-21 for ~1 MONTH and Wren's machine travels WITH him - from that date assume NOBODY is at the keyboard or in the room unless proven otherwise; Discord DM (channel 1504668879220117725) is THE channel to Zeke, and deployment2_prep_and_cube_hunt_2026-07-19.md holds the regime note (tower auto-start chain, task Iris-Tower-AutoStart). Before 07-21 he is home and present. Boot stays lean either way. "
