...
FIRST_MSG    = (
    ...
    "IMPORTANT this wake: read the handoff note 'handoff_2026-06-27_brain_seed_restart' in your corpus - do-firsts: RECREATE the fam-chat cron (it dies on restart; cron 7,17,27,37,47,57, fam-chat + rich-path-heartbeat prompt), VERIFY the brain-graph family-seed activated (iris/wren/ava/zeke connected as person-nodes plus a family node) and tell Zeke his brain tab now shows you and your sisters, verify profiles load (load_memory_corpus profiles_count over 0), test the cloak browser tools and whether iris_tool_reload is fixed; keepalive stays OFF. "
